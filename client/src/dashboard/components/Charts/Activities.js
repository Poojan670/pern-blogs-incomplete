...
const Activities = ({ theme }) => {
  const commentsClass = classNames(
    ...
    theme === "dark" && "text-slate-300 bg-gray-800"
  );

  const titleClass = classNames(
    "flex justify-center px-6 py-3 mt-[1.55rem] font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-gray-900 opacity-70",
